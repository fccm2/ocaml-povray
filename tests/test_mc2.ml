...
let mesh_color0 = PovColor.Cyan
let mesh_color1 = PovColor.Green
let mesh_color2 = PovColor.Magenta
let mesh_color3 = PovColor.Yellow

let triangles = [
  (* top-side *)
  ( (-1.2, 1.2, -1.2), (1.2, 1.2, -1.2), (1.2, 1.2, 1.2) ), mesh_color0;
  ( (-1.2, 1.2, -1.2), (-1.2, 1.2, 1.2), (1.2, 1.2, 1.2) ), mesh_color2;

  (* left-side *)
  ( (-1.2, -1.2, -1.2), (-1.2, 1.2, -1.2), (-1.2, 1.2, 1.2) ), mesh_color1;
  ( (-1.2, -1.2, -1.2), (-1.2, -1.2, 1.2), (-1.2, 1.2, 1.2) ), mesh_color3;
]
